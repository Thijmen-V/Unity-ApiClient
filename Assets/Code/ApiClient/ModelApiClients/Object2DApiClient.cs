...
public class Object2DApiClient : MonoBehaviour
{
    ...
    {
        string route = "/environments/" + environmentId + "/object";
    ...
    {
        string route = "/environments/" + object2D.environmentId + "/object";
    ...
    {
        string route = "/environments/" + object2D.environmentId + "/object/" + object2D.id;
        string data = JsonUtility.ToJson(object2D);
